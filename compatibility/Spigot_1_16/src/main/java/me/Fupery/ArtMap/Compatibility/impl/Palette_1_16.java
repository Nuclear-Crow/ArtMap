...
public class Palette_1_16 implements Palette {
	public final ArtDye
			...
			WHITE 				= new BasicDye(Lang.DYE_WHITE.get(), "WHITE", 14, ChatColor.WHITE, Material.WHITE_DYE),
	        ...
	        BLUE 				= new BasicDye(Lang.DYE_BLUE.get(), "BLUE", 25, ChatColor.BLUE, Material.BLUE_DYE),
	        BROWN 				= new BasicDye(Lang.DYE_BROWN.get(), "BROWN", 26, ChatColor.DARK_RED, Material.BROWN_DYE),
	        ...
	        BLACK 				= new BasicDye(Lang.DYE_BLACK.get(), "BLACK", 29, ChatColor.DARK_GRAY, Material.BLACK_DYE),
