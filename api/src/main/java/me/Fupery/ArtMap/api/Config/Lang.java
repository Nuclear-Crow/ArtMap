...
public enum Lang implements LangSet<String> {
    ...
    SEARCH_PAGE_SEPERATOR, SEARCH_BY, ITEM_SPONGE_MESSAGE, ARTKIT_NEXT, ARTKIT_PREV, RECIPE_MEDIUM_CANVAS_NAME, RECIPE_LARGE_CANVAS_NAME;
    ...
    public enum Array implements LangSet<String[]> {
		...
		TOOL_BUCKET, TOOL_SPONGE, RECIPE_PAINT_BRUSH, CONSOLE_HELP, RECIPE_MEDIUM_CANVAS, RECIPE_LARGE_CANVAS;
